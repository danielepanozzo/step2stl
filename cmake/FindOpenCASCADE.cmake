...
IF( NOT OpenCASCADE_FOUND STREQUAL TRUE )
  IF(UNIX)
    set( _incsearchpath /usr/include/opencascade /opt/occ/inc $ENV{CASROOT}/inc /usr/local/include /usr/local/include/opencascade)
    if (APPLE)
      set( _testlibname libTKernel.dylib )
    else (APPLE)
      set( _testlibname libTKernel.so )
    endif (APPLE)
    set( _libsearchpath /usr/lib /opt/occ/lib $ENV{CASROOT}/lib /usr/local/lib)
  ELSE(UNIX)
    IF (WIN32)
...
IF( OpenCASCADE_FOUND STREQUAL TRUE )
  SET(OpenCASCADE_FIND_COMPONENTS TKernel TKBRep TKStep TKSTL TKXSBase TKGeomBase TKG3d TKMesh)
